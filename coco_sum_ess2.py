...
# 读取数据
ceo = pl.read_csv("/home/isss/ravenpackdataset/new_data.csv")
ticker_entity_id = pl.read_csv("/home/isss/ravenpackdataset/newdata_mapping.csv")
...
for year in tqdm(years, desc="Loading event data"):
    dic[year] = pl.read_csv(f'/home/isss/ravenpackdataset/{year}_events2.csv')
...
ceodata.write_csv('/home/isss/ravenpackdataset/ceodata_2.csv')